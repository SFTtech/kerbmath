...
class Atmosphere:
	def __init__(self, cutoff = 0, scaleh = 0, p0 = 0, rho0 = 0):
		...
		cutoff
			The cutoff height (m)
		scaleh
			The scale height (where pressure/density decreses by e; m)
		p0
			The surface pressure (N/m^2)
		rho0
			The surface density (kg/m^3)
		"""
	...
	def accel(self, h, v, d = 0.2):
		...
		d
			Drag coefficient of the ship (usually 0.2, unitless)
		returns
			Acceleration due to drag (m/s^2, positive)
		"""
